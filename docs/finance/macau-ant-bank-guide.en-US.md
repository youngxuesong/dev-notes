---
title: 04. Ant Bank Macau: Frictionless Offshore Account Setup
order: 5
---
...
```mermaid
graph LR
    User[Traveler inside Macau] --> App[Download & Open Ant Bank MO App]
    App --> Scan[Scan Identity Documents & EEP]
    Scan --> Face[Biometric Facial Match]
    Face --> Pass[Rapid Approval & Instant Activation]
    Pass --> Wallet[Alipay+ Integration / Multi-Currency Holding]
```
