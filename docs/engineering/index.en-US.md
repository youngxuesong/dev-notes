...
# 🛠️ System Engineering & Operations

Hands-on notes on resilient API gateways, failover routing, production DevOps, and daily troubleshooting snippets (TIL).
...
- [Starter Guide: Codex & Unified API Gateway Setup (CCSwitch / Cockpit / SDKs)](/en-US/engineering/codex-api-guide)
